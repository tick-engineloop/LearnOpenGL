...
int main(int argc, char* argv[])
{
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		// --------------------------------------------------------------------------------------------------------------
        // 因为在 solid pass 中开启了深度测试，在 transparent pass 中未关闭深度测试，所以在 transparent pass 中继续执行深度测试。
        // 这里还使用了 glDepthMask(GL_FALSE) 函数，所以在 transparent pass 中关闭了对深度缓冲区的写入，禁止了对深度缓冲区的更新。
